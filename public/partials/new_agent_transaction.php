...
$users_details=$query->iWhileFetch($users);
			...
			if (isset($_POST['btn_add_my_transactions'])) {
		        ...
		        $transactionData['uid'] = sanitize_text_field($_POST['agent']);
    ...
    <div class="col-lg-12">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        <label for="agents" class="form-label custom-label">Select an Agent</label>
                        <select name="agent" id="agents" class="form-control" required>
